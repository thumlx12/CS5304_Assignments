...
val_data.classes = train_data.classes
...
label_dict = {'n09193705':0, 'n09246464':1, 'n09256479':2, 'n09332890':3, 'n09428293':4}
...
# 2. fine-tune the entire pre-trained network
...
optimizer_ft = optim.SGD(model_ft.parameters(), lr=0.001, momentum=0.9, , weight_decay=0.02)
...
#save the models
torch.save(model_conv.state_dict(),'/home/nbuser/model_cnn.pt')


# In[ ]:


torch.save(model_ft.state_dict(),'/home/nbuser/model_ft.pt')
